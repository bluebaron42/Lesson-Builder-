...
## 📚 CRITICAL: Authoritative Content Sources

**EXPLICIT REQUIREMENT**: All lesson content MUST be derived from these official AQA Psychology textbooks:

- **Year 1 & AS Level**: `Textbooks/AQA Year 1 textbook work.txt`
...
**Why this matters:**
- These are the official AQA curriculum-aligned textbooks
- Ensures accuracy, exam specification alignment, and research citation standards
- Provides consistent terminology, study references, and evaluation points
- ALL concepts, studies, theories, and terminology should trace back to these sources

**Do NOT generate lesson content from general knowledge or external sources without verifying against these textbooks first.**
...
**CRITICAL**: Add a `displayName` field to `package.json` to ensure proper module identification in Psych-hub. Prompt me to give you this displayName as it is case sensitive.
